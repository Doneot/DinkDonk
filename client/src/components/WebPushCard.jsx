  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md">
      ...
      <p className="text-sm text-gray-600 mb-4">
        Get native notifications from this browser when subscribed streamers go
        live.
      </p>

      {!supported ? (
        <p className="text-sm text-gray-500">
          Web Push is not supported here. On iPhone/iPad, add DinkDonk to your
        ...
        <button
          ...
          disabled={loading}
          onClick={disable}
          className="px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-700 disabled:opacity-50 cursor-pointer"
        >
        ...
        <button
          ...
          disabled={loading}
          onClick={enable}
          className="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 disabled:opacity-50 cursor-pointer"
        >
