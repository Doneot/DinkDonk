    ...
    <div className="max-w-4xl mx-auto px-6 py-12 bg-bg text-ink-dim">
      ...
      <section className="mb-10">
        ...
        <p>
          ...
          you use our service, which provides Twitch stream notifications via
          Discord.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <ul className="list-disc pl-5 marker:text-accent">
          ...
          <li>
            <strong>Twitch streamers you follow:</strong> To determine who you
            want notifications for.
          </li>
          <li>
            <strong>Notification preferences:</strong> To manage how and when
            you are notified.
          </li>
        </ul>
        <p className="mt-2">
          We do <strong>not</strong> collect your email address, phone number,
          or passwords.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p>
          Your data is stored securely in a protected Firestore database. We
          follow industry-standard practices to prevent unauthorized access.
          Tokens (if used) are encrypted and never shared.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="mt-2">
          Both platforms have their own privacy policies which you should
          review.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p>
          ...
          posted on this page with an updated effective date. We may notify you
          via Discord or the dashboard if the changes are significant.
        </p>
      </section>
